...
HBAR 属于'超导电路+机械振子'大家族的体声波分支；综述把整个家族放进统一图景——**电机械系统**（电容换能：微波电场耦合应变，HBAR/鼓面模/悬臂）与**光机械系统**（光压换能：光学腔场耦合机械位移）两类换能机制，都可作为超导比特的混合伙伴，并在微波-光转换（量子中继的关键接口）上交汇。HBAR 的多模密集声学谱（存储阵列）与光机械的光频接口（远程连接）在应用上互补。把这类机械振子冷到近基态是利用其量子性质的第一步——微波频段的测量基[[circuit-qed/feedback-cooling|反馈冷却]]已把 SiN 膜做到 1.6 个声子。
...
机械振子经腔总线耦合时，**量子反作用**设定耦合的极限：测量光子对振子的随机辐射压力扰动与耦合强度同步增长——更强的耦合同时带来更强的反作用噪声，联合量子涨落决定可分辨的耦合信号上限。机械振子对的腔介导耦合在此极限下分析，给出"能耦合到多强"的基本答案。

![[assets/figures/hbar-quantum-acoustodynamics/797b02e7da2aa90a409f200a246dc25b37145853dc5927b1d4997d736ab76462.jpg]]

*量子反作用限制的机械耦合：辐射压力扰动与耦合强度的同步——联合涨落决定耦合信号上限。图源：Tsang&Caves 类 (2015)，Fig. 1。*

![[assets/figures/hbar-quantum-acoustodynamics/6e8cbdc93f448c64287f35a2c7b60df73929840c29eefd2f1cd8dbf867aee3b6.jpg]]
