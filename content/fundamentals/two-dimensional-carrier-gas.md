...
- R. Dingle, H. L. Störmer, A. C. Gossard, and W. Wiegmann, "Electron mobilities in modulation-doped semiconductor heterojunction superlattices", *Applied Physics Letters* (1978). [DOI: 10.1063/1.90282]
- F. Schäffler, "High-mobility Si and Ge structures", *Semiconductor Science and Technology* (1997). [DOI: 10.1088/0268-1242/12/12/001]
- L. A. Tracy et al., "Single shot spin readout using a cryogenic high-electron-mobility transistor amplifier", *Applied Physics Letters* (2010). arXiv: 1012.3466
