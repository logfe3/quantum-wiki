...
- **激发态资源**：跳出基态双态的另一条路——硅 MOS 空穴点中激发双态参与的跃迁 Rabi 频率比基态双态高 1–4 个量级（面内驱动下可达 THz），可做激发态编码、qudit 或 Raman 虚跃迁中继，见[[qubit-control/hole-excited-state-rabi|空穴激发态巨拉比跃迁]]。
