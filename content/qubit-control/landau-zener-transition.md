...
标准 LZ 公式与实验之间长期隔着一条缝隙——实验数据分析中常用的一些近似并不准确。该论文为超导比特的 LZ 跃迁率与量子点吸收谱推导了**精确公式**：给出任意振荡周期下跃迁率极大/极小值的显式表达式，修正了此前实验研究引用的近似结果。对实验者的直接意义：从测得的振荡谱提取参数（如隧穿耦合 $Delta$、驱动幅度 $）时，用精确公式可避免系统偏差。

![[assets/figures/landau-zener-transition/94044ea4774f70f18947d6acc5faacc92f7c7da0e7560e849052342ea5ae4d8c.jpg]]

*跃迁率 W 随驱动幅度 A 的精确行为（以 $Delta^2/omega$ 为单位）：极大/极小值的位置与高度由显式公式给出——旧近似在这些特征点附近偏离精确结果。图源：arXiv:2310.13058，Fig. 1。*

![[assets/figures/landau-zener-transition/d0048c89803200b9e87ccdafdf9bf9784492cd876f245e3abd0b67b8a38b350f.jpg]]
