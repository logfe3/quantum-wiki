...
门电极的电容参数与栅型紧密相关：文献给出经验参考值——GaAs 中 plunger gate 杠杆臂 $\alpha\approx 0.05$、barrier gate $\alpha\approx 0.1$（无量纲）。横向量子点的典型尺寸约 $200\ \mathrm{nm}$，与费米波长同量级，因此量子点少电子区由若干条子带贡献。
