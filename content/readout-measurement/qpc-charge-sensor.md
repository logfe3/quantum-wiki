...
- M. Field, C. G. Smith, M. Pepper, D. A. Ritchie, J. E. F. Frost, G. A. C. Jones, D. G. Hasko, "Measurements of Coulomb blockade with a non-invasive voltage probe", *Physical Review Letters* (1993). [DOI: 10.1103/PhysRevLett.70.1311]
- J. M. Elzerman, R. Hanson, L. H. W. van Beveren, B. Witkamp, L. M. K. Vandersypen, L. P. Kouwenhoven, "Single-shot read-out of an individual electron spin in a quantum dot", *Nature* (2004). [DOI: 10.1038/nature02693]
- D. J. Reilly et al., "Shot-Noise-Limited Operation of a Fast Quantum-Point-Contact Charge Sensor", arXiv (2007). [arXiv: 0708.0861]
- D. J. Reilly, "An in-situ tunable radio-frequency quantum point contact", arXiv (2010). [arXiv: 1009.1746]
