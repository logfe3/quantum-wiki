...
**侧信道脆弱性**是串扰的安全维度：频分复用让多个谐振器共享一根馈线——共享带来的不只是串扰误差，还有**信息泄露**：一个比特的读出信号在相邻比特的通道中留下可提取的痕迹（侧信道）。对量子密码/云量子计算的安全性分析，侧信道成为新的攻击面；缓解方案（滤波隔离、通道泄漏量化）与串扰抑制共享同一套物理。

![[assets/figures/readout-crosstalk/9745d3726748e79e8c0185d049eddb91619f5013075ec8b4f3bad92ef4d05407.jpg]]

*频分复用的侧信道：共享馈线上比特间信息泄露——一个通道的信号在相邻通道留下痕迹。图源：arXiv:2405.08962，Fig. 1。*

![[assets/figures/readout-crosstalk/281e719f088f54e50f236e1d7fbc52921454417a3bda948932e08177d2937486.jpg]]
...
- [[superconducting-qubits/real-time-qec-decoding|实时低延迟量子纠错解码]]：复用读出的缺陷率与读出串扰直接进入解码时间——噪声越高缺陷越多、每轮解码越慢，实时解码预算因此反向约束读出链设计。
