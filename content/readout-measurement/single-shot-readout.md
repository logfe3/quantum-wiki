...
Q3 的 $E_\mathrm{sep}$ 仅 $0.001\%$，几乎全部错误来自弛豫与串扰；Q6 的 SNR 较低，是因为其腔频落在[[readout-measurement/parametric-amplifier|阻抗匹配参量放大器（IMPA）]]增益边缘，态分离错误占总错误的 $67\%$。在 300–500 ns 读取时间下 $|0\rangle$ 态保真度最高 99.52%，$|1\rangle$ 态最高 97%。
